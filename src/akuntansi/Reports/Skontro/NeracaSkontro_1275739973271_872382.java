 ...
 *
 */
public class NeracaSkontro_1275739973271_872382 extends JREvaluator
{
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 9 : 
            {
                value = (java.sql.Connection)(((java.sql.Connection)parameter_REPORT_CONNECTION.getValue()));//$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = (java.lang.String)(((java.lang.String)parameter_SUBREPORT_DIR.getValue()) + "Aktiva.jasper");//$JR_EXPR_ID=10$
                break;
            }
           default :
           {
