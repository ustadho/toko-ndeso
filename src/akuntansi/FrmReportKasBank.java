 ...
 * @author ustadho
 */
public class FrmReportKasBank extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            switch(jListMenu.getSelectedIndex()){
                case 0:{
                    ...
                    reportParam.put("sHead", "Jurnal Kas & Bank Masuk");
                    reportParam.put("tipe", "BKM");
                    reportParam.put("sUnit", cmbUnit.getSelectedItem().toString());
                    jasperReport = (JasperReport) JRLoader.loadObject(getClass().getResourceAsStream("Reports/BK_JournalDet.jasper"));
                ...
                case 1:{
                    ...
                    reportParam.put("tanggal2", new SimpleDateFormat("yyyy-MM-dd").format(jXDatePicker2.getDate()));
                    reportParam.put("unit", sUnit);
                    reportParam.put("sHead", "Jurnal Kas & Bank Keluar");
                    reportParam.put("tipe", "BKK");
                    reportParam.put("sUnit", cmbUnit.getSelectedItem().toString());
                    jasperReport = (JasperReport) JRLoader.loadObject(getClass().getResourceAsStream("Reports/BK_JournalDet.jasper"));
                ...
                case 2:{
                    ...
                    reportParam.put("sHeader", "Buku Bank");
                    reportParam.put("sUnit", cmbUnit.getSelectedItem().toString());
                ...
                case 3:{
                    ...
                    reportParam.put("unit", sUnit);
                    reportParam.put("tipe", "BKK");
                    reportParam.put("sHead", "Ringkasan Daftar Kas & Bank Keluar");
                    reportParam.put("sUnit", cmbUnit.getSelectedItem().toString());
                    jasperReport = (JasperReport) JRLoader.loadObject(getClass().getResourceAsStream("Reports/BK_Rekap.jasper"));
                    break;
                }
                case 4:{
                    reportParam.put("tanggal1", new SimpleDateFormat("yyyy-MM-dd").format(jXDatePicker1.getDate()));
    ...
    private void initComponents() {
        ...
        jListMenu.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Jurnal Kas/ Bank Masuk", "Jurnal Kas/ Bank Keluar", "Buku Bank", "Daftar Akun Kas & Bank", "Bukti Kas dan Bank Keluar (Rekap)", "Bukti Kas dan Bank Keluar (Detail)", " " };
    ...
    private void jListMenuValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jListMenuValueChanged
        ...
        jPanel2.setVisible(iList==0 || iList==1||iList==4);
        txtAccNo.setVisible(iList==2);
    ...
    private void txtAccNoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAccNoKeyReleased
        String sQry =   "select a.acc_no, a.acc_name " +
                        ...
                        "and acc_type='01' and a.acc_no not in(select distinct sub_acc_of from acc_coa where acc_type='01' and sub_acc_of is not null) " +
                        "order by acc_no ";
        fn.lookup(evt, new Object[]{txtAccName}, sQry, txtAccNo.getWidth()+txtAccName.getWidth()+18, 150);
