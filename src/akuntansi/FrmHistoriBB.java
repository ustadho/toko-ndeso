 ...
 * @author  oestadho
 */
public class FrmHistoriBB extends javax.swing.JInternalFrame {
...
//        masterTable.getColumn("Nama Item").setPreferredWidth(200);
    ...
    private void udfFilter(){
        ...
        String s="select * from (select * from fn_acc_histori_bb('"+new SimpleDateFormat("yyyy-MM-dd").format(jDateChooser1.getDate())+"', '"+ new SimpleDateFormat("yyyy-MM-dd").format(jDateChooser2.getDate()) +"', '', '') as (tanggal date, sumber varchar, journal_no varchar, " +
                "acc_no varchar, acc_name varchar, keterangan text, debet double precision, kredit double precision) " +
                ") x where acc_no||acc_name||keterangan ilike '%"+txtNama.getText()+"%'";
        try {
...
//    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("History Buku Besar"); // NOI18N
        setName("Form"); // NOI18N
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FrmHistoriBB.class);
        ...
        masterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal", "Sumber", "No. Sumber", "Keterangan", "No. Akun", "Nama Akun", "Debet", "Kredit"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class
            };
...
private void chkTanggalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkTanggalActionPerformed
    btnLoad.setEnabled(chkTanggal.isSelected());
    udfFilter();
