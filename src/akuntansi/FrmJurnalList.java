 ...
 * @author  oestadho
 */
public class FrmJurnalList extends javax.swing.JInternalFrame {
...
//        sTipe+=(sTipe.length()>0? ",": "")+"''";
        ...
        String s="select * from (select * from fn_acc_histori_journal('"+ new SimpleDateFormat("yyyy-MM-dd").format(jDateChooser1.getDate()) +"', " +
                "'"+ new SimpleDateFormat("yyyy-MM-dd").format(jDateChooser2.getDate()) +"', '', '') " +
                "as (tanggal date, tipe varchar, journal_no varchar, keterangan text, amount double precision)) a " +
                "where journal_no||keterangan ilike '%"+txtNama.getText()+"%' ";
...
//    }
    ...
    private void initComponents() {
        ...
        lblUbah.setText("Ubah"); // NOI18N
        lblUbah.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        masterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Tanggal", "Tipe", "Amount", "Keterangan"
            }
        ) {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FrmJurnalList.class);
...
//            }
    ...
    public class MyRowRenderer extends DefaultTableCellRenderer implements TableCellRenderer{
        ...
        NumberFormat numFmt=GeneralFunction.dFmt;
