 ...
 * @author cak-ust
 */
public class FrmItemPriceList extends javax.swing.JInternalFrame {
...
//                }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode", "Nama Barang", "Satuan", "Tipe Harga", "Jml Print", "Print"
            }
        ) {
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        try{
            ResultSet rs=conn.createStatement().executeQuery(
                    "select i.kode_item, i.nama_item, unit, coalesce(harga_r_1,0) as harga "
                    
                    + "from r_item i "
                    + "left join r_item_harga_jual h on h.kode_item=i.kode_item "
                    + "where kategori='"+jComboBox1.getSelectedItem().toString()+"'" );
            while(rs.next()){
    ...
    private void btnPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreviewActionPerformed
        try {                                           
            ...
            Logger.getLogger(FrmItemPriceList.class.getName()).log(Level.SEVERE, null, ex);
        }
