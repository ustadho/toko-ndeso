 ...
 * @author cak-ust
 */
public class DlgSaldoAwCustomer extends javax.swing.JDialog {
    ...
    public DlgSaldoAwCustomer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void udfInitForm(){
        ...
        try{
            ResultSet rs=conn.createStatement().executeQuery(
                    "select no_inv, tanggal, coalesce(nilai_faktur,0) as nilai_faktur, coalesce(termin,'') as termin " +
                    "from r_cust_saldo_awal " +
                    "where kode_cust='"+sKodeCust+"'");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgSaldoAwCustomer dialog = new DlgSaldoAwCustomer(new javax.swing.JFrame(), true);
    ...
    private void udfSave() {
        try{
            ...
            for(int i=0; i< jTable1.getRowCount(); i++){
                ...
                sQry+="select fn_r_cust_saldo_awal('"+sOldFAktur+"', " +
            ...
            if(rs.next()){
                ...
                if(objForm!=null && objForm instanceof FrmCustomerMaster)
                    ((FrmCustomerMaster)objForm).saldoAwal();
            }
            this.dispose();
        }catch(SQLException se){
            JOptionPane.showMessageDialog(this, se.getMessage());
