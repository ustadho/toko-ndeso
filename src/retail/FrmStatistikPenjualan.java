 ...
 * @author cak-ust
 */
public class FrmStatistikPenjualan extends javax.swing.JInternalFrame {
    private Connection conn;
    ChartPanel chartPanel;
    private GeneralFunction fn=new GeneralFunction();
    
    /** Creates new form FrmStatistikPenjualan */
    public FrmStatistikPenjualan() {
        initComponents();
    }

    private void udfViewPenjualanPerCust(){
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        try{
            String sQry="select nama||' ('||kode_cust||')' as \"Customer\", sum(sub_total) as \"Total\" "
        ...
        JFreeChart chart = ChartFactory.createBarChart(
            "Penjualan per Customer",       // chart title
            "Customer",               // domain axis label
    ...
    private void udfViewPenjualanPerTanggal(){
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        try{
            String sQry="select to_char(sales_date,'dd/MM/yy') as \"Tanggal\", sum(sub_total) as \"Total\" "
                    + "from fn_r_rpt_sales_detail('"+new SimpleDateFormat("yyyy-MM-dd").format(jXDatePicker1.getDate())+"', "
                    + "'"+new SimpleDateFormat("yyyy-MM-dd").format(jXDatePicker2.getDate())+"', '', '', '') as (jenis text, sales_date date, kode_cust varchar, "
                    + "nama varchar, sales_no varchar, kode_item varchar, nama_item varchar, qty numeric, unit_price double precision,"
                    + "disc double precision, tax double precision, sub_total double precision) "
                    + "group by to_char(sales_date,'dd/MM/yy'), sales_date "
                    + "order by sales_date ";
        ...
        JFreeChart chart = ChartFactory.createBarChart(
            "Penjualan per Tanggal",       // chart title
    ...
    private void udfViewPenjualanPerBulan(){
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        try{
            String sQry="select to_char(sales_date,'MM-yy') as \"Bulan\", sum(sub_total) as \"Total\" "
                    + "from fn_r_rpt_sales_detail('"+new SimpleDateFormat("yyyy-MM-dd").format(jXDatePicker1.getDate())+"', "
                    + "'"+new SimpleDateFormat("yyyy-MM-dd").format(jXDatePicker2.getDate())+"', '', '', '') as (jenis text, sales_date date, kode_cust varchar, "
                    + "nama varchar, sales_no varchar, kode_item varchar, nama_item varchar, qty numeric, unit_price double precision,"
                    + "disc double precision, tax double precision, sub_total double precision) "
        ...
        JFreeChart chart = ChartFactory.createBarChart(
            "Penjualan per Bulan",       // chart title
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Statistik Penjualan");

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 24));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("STATISTIK DAN ANALISA DATA PENJUALAN");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Penjualan per Pelanggan", "Penjualan per Hari", "Penjualan per Cara Bayar", "Penjualan per Bulan", "Penjualan per Cara Bayar Per Hari", "Penjualan per Cara Bayar Per Bulan" }));
        jComboBox1.setName("jComboBox1"); // NOI18N
        jPanel2.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 344, -1));

        jXDatePicker1.setName("jXDatePicker1"); // NOI18N
        jPanel2.add(jXDatePicker1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 20, 140, -1));

        jXDatePicker2.setName("jXDatePicker2"); // NOI18N
        jPanel2.add(jXDatePicker2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 20, 120, -1));
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 0, 140, 20));

        jLabel4.setForeground(new java.awt.Color(0, 0, 102));
        jLabel4.setText("Sampai :");
        jLabel4.setName("jLabel4"); // NOI18N
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 0, 120, 20));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addComponent(card, javax.swing.GroupLayout.DEFAULT_SIZE, 760, Short.MAX_VALUE)
                .addGap(10, 10, 10))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(10, 10, 10)
                .addComponent(card, javax.swing.GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE)
                .addGap(11, 11, 11))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        switch(jComboBox1.getSelectedIndex()){
            case 0:{
                udfViewPenjualanPerCust();
                break;
            }
            case 1:{
                udfViewPenjualanPerTanggal();
                break;
            }
            case 2:{
                udfViewPenjualanPerJenisBayar();
                break;
            }
            case 3:{
                udfViewPenjualanPerBulan();
                break;
            }
            case 4:{
                udfViewPenjualanPerJenisBayarPerHari();
                break;
            }
            case 5:{
                udfViewPenjualanPerJenisBayarPerBulan();
                break;
            }
            default:{
                break;
