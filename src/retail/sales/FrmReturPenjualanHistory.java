...
//        tblDetail.getColumn("SisaPR").setMinWidth(0); tblDetail.getColumn("SisaPR").setMaxWidth(0); tblDetail.getColumn("SisaPR").setPreferredWidth(0);
    ...
    private void udfLoadReturDetail(){
        ...
        String s ="select d.kode_item, coalesce(i.nama_item,'') as nama_item, " +
                "coalesce(d.qty,0) as qty, coalesce(i.unit,'') as unit, coalesce(d.unit_Price,0) as unit_price," +
    ...
    public void udfLoadRetur(){
        try{
            ...
            String sQry="select distinct r.no_retur, r.kode_cust, coalesce(c.nama,'') as nama_cust, r.tanggal, " +
                    "r.date_ins , coalesce(r.keterangan,'') as remark " +
                    "from r_retur_jual r " +
                    "inner join r_retur_jual_detail d on d.no_retur=r.no_retur " +
                    ...
                    "and coalesce(c.nama,'')||r.kode_cust||r.no_retur ilike '%"+txtSupplier.getText()+"%' " +
    ...
    private void udfBatalRetur() {
        ...
        try{
            ...
            ResultSet rs=conn.createStatement().executeQuery("select fn_r_retur_jual_koreksi('"+sNoRetur+"', '"+MainForm.sUserName+"')");
            if(rs.next()){
...
//                }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 10, 50, 60));
        ...
        jPanel1.add(btnPreview, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 10, 50, 60));
        ...
        jPanel1.add(btnKoreksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 10, 50, 60));
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 10, 50, 60));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jXTitledPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 840, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
...
private void printKwitansi(){
        int iRow=tblHeader.getSelectedRow();
        if(iRow < 0) return;
        String sNo=tblHeader.getValueAt(iRow, 0).toString();
        ...
        try{
            PrintPenjualanRetur pn = new PrintPenjualanRetur(conn, sNo, MainForm.sUserName,services[i]);
